...
namespace bitsplat
{
    ...
    public class DbMigrationsRunner<T> 
        : IDbMigrationsRunner where T : MigrationProcessorFactory, new()
    {
        ...
        private void DoMigration(
            Action<MigrationRunner> call)
        {
            var options = new MigrationOptions();
            DoMigrationsWithOptions(options, call);
        }

        private void DoMigrationsWithOptions(
